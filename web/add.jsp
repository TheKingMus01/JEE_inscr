...
#back{
    ...
    <center>
        ...
        %>
        <h1 >
            <u>  ajouter un Etudiant a la formation : <%= code%> </u></h1>
            ...
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        <h3>Insertion </h3>
                        <p>ajouter un Etudiant a la formation : <%= code%></p>
                        <form class="requires-validation" action="Controleur"  action="POST" novalidate>
                            <input type="hidden" name="do_this" value="insertinF"/>
                           
                           <label class="mb-3 mr-1" >Sélectionner l'étudiant: </label>

                            <div class="col-md-12 mt-3">
                            <label class="mb-3 mr-1" for="CNE">CNE: </label>
                            
                            <c:forEach var="Etudiant" items = "${requestScope.listEtudiants}">
                            <input type="radio" class="btn-check" name="CNE" id="${Etudiant.CNE}" autocomplete="off" value="${Etudiant.CNE}" required>
                            <label class="btn btn-sm btn-outline-secondary" for="${Etudiant.CNE}">${Etudiant.CNE}</label>
                            </c:forEach>
                           ...
                           <div class="col-md-12" hidden>
                                <input type="text" name="code_de_formation" value="<%= code%>" required>
                            </div>
