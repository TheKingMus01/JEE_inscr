                ...
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <form class="requires-validation" action="Controleur"  action="POST" novalidate>
                            <input type="hidden" name="do_this" value="selectFormation"/>
                            <div class="col-md-12">
                               <input class="form-control" type="text" name="cne" placeholder="CNE" required>
                            ...
                            <div class="col-md-12">
                               <input class="form-control" type="date" name="date_de_naissance" placeholder="date_de_naissance" required>
                           ...
                           <div class="col-md-12">
                               <select class="form-select mt-3" name="code_de_formation" required>
